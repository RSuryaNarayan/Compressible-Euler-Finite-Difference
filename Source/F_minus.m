function fm = F_minus(u, v, p, rho, xi_x, xi_y,J)
    ...
    L_m = zeros(4,4);
    L_m(1,1) = r_xi*0.5*(u_d-a-sqrt((u_d-a)^2+e^2));
    L_m(2,2) = r_xi*0.5*(u_d-sqrt(u_d^2+e^2));
    L_m(3,3) = r_xi*0.5*(u_d+a-sqrt((u_d+a)^2+e^2));
    L_m(4,4) = r_xi*0.5*(u_d-sqrt(u_d^2+e^2));
